...
class SignupActivity : AppCompatActivity() {
    ...
    private fun playAnimation() {
        ...
        val littleText = ObjectAnimator.ofFloat(binding.titleTextView, View.ALPHA, 1f).setDuration(100)
...
//        }
        ...
        AnimatorSet().apply {
            playSequentially(littleText, nameText, nameEdit, emailText, emailEdit, passwordText, passwordEdit, signupBtn)
            start()
        }
    }
}