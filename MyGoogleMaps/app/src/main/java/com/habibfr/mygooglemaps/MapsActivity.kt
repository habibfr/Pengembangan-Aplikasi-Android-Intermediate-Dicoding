package com.habibfr.mygooglemaps
...
import com.habibfr.mygooglemaps.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val sby = LatLng(-7.250445, 112.768845)
        mMap.addMarker(
            MarkerOptions().position(sby).title("Marker in Surabaya")
                .snippet("Surabaya Kota Pahlawan")
        )
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(sby, 15f))
